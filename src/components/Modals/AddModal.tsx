...
interface AddModalProps{
  isOpen: boolean;
  onClose: () => void;
  setOpen: React.Dispatch<React.SetStateAction<boolean>> //This indicates that the setOpen prop is expected to be a function that can update the state of a boolean value.
...
const AddModal = ({isOpen, onClose, setOpen, handleAddTask}:AddModalProps) => {
  const initialTaskData = {
    ...
    image: "",
    alt:"",
    tags:[] as Tag[], //provides additional clarity and can help avoid potential issues related to type inference in certain scenarios
  }
